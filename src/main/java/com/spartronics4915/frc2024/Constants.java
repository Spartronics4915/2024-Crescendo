...
public final class Constants {
    ...
    public static final class Drive {
        ...
        public static final PIDConstants kAngleControllerPIDConstants = new PIDConstants(1.0, 0.0, 0.0); // FIXME:
                                                                                                         // placeholder
                                                                                                         // values
        ...
        public static final PIDFConstants kDrivePIDFConstants = new PIDFConstants(1.0, 0.0, 0.0, 0.0); // placeholder
                                                                                                       // values
        public static final PIDFConstants kAnglePIDFConstants = new PIDFConstants(1.0, 0.0, 0.0, 0.0); // placeholder
                                                                                                       // values
    ...
    public static final class IntakeAssembly {
        public enum IntakeAssemblyState { // TODO find constants
            GROUNDPICKUP(Rotation2d.fromDegrees(90.0), 0.0), STOW(Rotation2d.fromDegrees(170.0), 0.0), AMP(
                    Rotation2d.fromDegrees(10.0), 0.0), LOAD(Rotation2d.fromDegrees(190.0),
                            0.0), SOURCE(Rotation2d.fromDegrees(120.0), 0.0), MANUAL(Rotation2d.fromDegrees(0.0), 0.0); // CHECKUP
                                                                                                                        // is
                                                                                                                        // this
                                                                                                                        // needed?
        ...
        public static final class IntakeConstants {
            public static final MotorConstants kMotorConstants = new MotorConstants(0, MotorType.kBrushless, false,
                    IdleMode.kBrake, 40);

            public static final PIDConstants kPIDconstants = new PIDConstants(1.0, 1.0, 1.0); // HACK DO NOT TEST WITH
                                                                                              // THESE VALUES
        ...
        public static final class IntakeWristConstants {
            ...
            public static final MotorConstants kMotorConstants = new MotorConstants(1, MotorType.kBrushless, false,
                    IdleMode.kBrake, 40);
            public static final PIDConstants kPIDConstants = new PIDConstants(0.25, 0.0, 0.0); // HACK DO NOT TEST WITH
                                                                                               // THESE VALUES
            public static final Constraints kTrapzoidConstraints = new Constraints(1, 1); // HACK DO NOT TEST WITH THESE
                                                                                          // VALUES
            ...
            public static final Rotation2d kMaxAngleAmp = Rotation2d.fromDegrees(90); // only when above the saftey
                                                                                      // height
            public static final Rotation2d kMaxAngleGround = Rotation2d.fromDegrees(120); // only when above the saftey
                                                                                          // height
        ...
        public static final class ElevatorConstants {
            public static final int kMotorLimits = 10;
            public static final MotorConstants kMotorConstants = new MotorConstants(10, MotorType.kBrushless, false,
                    IdleMode.kBrake, kMotorLimits);
            public static final MotorConstants kFollowerConstants = new MotorConstants(11, MotorType.kBrushless, true,
                    IdleMode.kBrake, kMotorLimits); // HACK untested
            ...
            public static final double kLimitSwitchGoto = 0; // Where the elevator will go to if the limit switch is
                                                             // triggered
            public static final double kMinimumManual = 0.1;
    ...
    public static final class ShooterWristConstants {
        ...
        public static final MotorConstants kMotorConstants = new MotorConstants(12, MotorType.kBrushless, false,
                IdleMode.kBrake, 40); // placeholder
        public static final PIDConstants kPIDconstants = new PIDConstants(1.0, 1.0, 1.0); // don't test with these
                                                                                          // values
        public static final Constraints kTrapzoidConstants = new Constraints(1, 1); // HACK DO NOT TEST WITH THESE
                                                                                    // VALUES
    ...
    public static final class ShooterConstants {
        public static final MotorConstants kShooterMotorConstants = new MotorConstants(13, MotorType.kBrushless, false,
                IdleMode.kBrake, 40); // placeholder
        public static final MotorConstants kShooterFollowMotorConstants = new MotorConstants(14, MotorType.kBrushless,
                false, IdleMode.kBrake, 40); // placeholder
        public static final MotorConstants kConveyorMotorConstants = new MotorConstants(15, MotorType.kBrushless, false,
                IdleMode.kBrake, 40); // placeholder
