...
public final class Constants {
    ...
    public static final class ShooterConstants {
        public static final MotorConstants kShooterMotorConstants = new MotorConstants(3, MotorType.kBrushless, false, IdleMode.kBrake, 40); //placeholder
        public static final MotorConstants kShooterFollowMotorConstants = new MotorConstants(2, MotorType.kBrushless, false, IdleMode.kBrake, 40); //placeholder
        public static final MotorConstants kConveyorMotorConstants = new MotorConstants(1, MotorType.kBrushless, false, IdleMode.kBrake, 40); //placeholder
        public static final PIDFConstants kPIDconstants = new PIDFConstants(1.0, 0.0, 0.0, 0);
